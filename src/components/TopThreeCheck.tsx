...
const TopThreeCheck: React.FC<TopThreeCheckProps> = ({ data }) => {
  ...
  const combinations = [
    ...
    {Comb:[21,4,7,10], style: '┊', quad: '1'},
    {Comb:[1,33,7,10], style: '┊', quad: '1'},
    {Comb:[1,4,36,10], style: '┊', quad: '1'},
    {Comb:[1,4,7,26], style: '┊', quad: '1'},
    {Comb:[2,5,8,11], style: '┊', quad: '1'},
    {Comb:[3,6,9,12], style: '┊', quad: '1'},
    {Comb:[23,6,9,12], style: '┊', quad: '1'},
    {Comb:[3,22,9,12], style: '┊', quad: '1'},
    {Comb:[3,6,34,12], style: '┊', quad: '1'},
    {Comb:[3,6,9,30], style: '┊', quad: '1'},
    {Comb:[20,5,8,11], style: '┊', quad: '1'},
    {Comb:[2,32,8,11], style: '┊', quad: '1'},
    {Comb:[2,5,35,11], style: '┊', quad: '1'},
    {Comb:[2,5,8,28], style: '┊', quad: '1'},
    {Comb:[0,1,4,7,10], style: '┊', quad: '1'},
    {Comb:[0,21,4,7,10], style: '┊', quad: '1'},
    {Comb:[0,1,33,7,10], style: '┊', quad: '1'},
    {Comb:[0,1,4,36,10], style: '┊', quad: '1'},
    {Comb:[0,1,4,7,26], style: '┊', quad: '1'},
    {Comb:[0,2,5,8,11], style: '┊', quad: '1'},
    {Comb:[0,20,5,8,11], style: '┊', quad: '1'},
    {Comb:[0,2,32,8,11], style: '┊', quad: '1'},
    {Comb:[0,2,5,35,11], style: '┊', quad: '1'},
    {Comb:[0,2,5,8,28], style: '┊', quad: '1'},
    {Comb:[0,3,6,9,12], style: '┊', quad: '1'},
    {Comb:[0,23,6,9,12], style: '┊', quad: '1'},
    {Comb:[0,3,22,9,12], style: '┊', quad: '1'},
    {Comb:[0,3,6,34,12], style: '┊', quad: '1'},
    {Comb:[0,3,6,9,30], style: '┊', quad: '1'},
    {Comb:[13,16,19,22], style: '┊', quad: '1'},
    {Comb:[29,16,19,22], style: '┊', quad: '1'},
    {Comb:[13,19,19,22], style: '┊', quad: '1'},
    {Comb:[13,16,16,22], style: '┊', quad: '1'},
    {Comb:[13,16,19,6], style: '┊', quad: '1'},
    {Comb:[14,17,20,23], style: '┊', quad: '1'},
    {Comb:[25,17,20,23], style: '┊', quad: '1'},
    {Comb:[14,31,20,23], style: '┊', quad: '1'},
    {Comb:[14,17,2,23], style: '┊', quad: '1'},
    {Comb:[14,17,20,3], style: '┊', quad: '1'},
    {Comb:[15,18,21,24], style: '┊', quad: '1'},
    {Comb:[24,18,21,24], style: '┊', quad: '1'},
    {Comb:[15,27,21,24], style: '┊', quad: '1'},
    {Comb:[15,18,1,24], style: '┊', quad: '1'},
    {Comb:[15,18,21,15], style: '┊', quad: '1'},
    {Comb:[25,28,31,34], style: '┊', quad: '1'},
    {Comb:[14,28,31,34], style: '┊', quad: '1'},
    {Comb:[25,11,31,34], style: '┊', quad: '1'},
    {Comb:[25,28,17,34], style: '┊', quad: '1'},
    {Comb:[25,28,31,9], style: '┊', quad: '1'},
    {Comb:[26,29,32,35], style: '┊', quad: '1'},
    {Comb:[10,29,32,35], style: '┊', quad: '1'},
    {Comb:[26,13,32,35], style: '┊', quad: '1'},
    {Comb:[26,29,5,35], style: '┊', quad: '1'},
    {Comb:[26,29,32,8], style: '┊', quad: '1'},
    {Comb:[27,30,33,36], style: '┊', quad: '1'},
    {Comb:[18,30,33,36], style: '┊', quad: '1'},
    {Comb:[27,12,33,36], style: '┊', quad: '1'},
    {Comb:[27,30,4,36], style: '┊', quad: '1'},
    {Comb:[27,30,33,7], style: '┊', quad: '1'},
    ...
    {Comb:[0,26,20,30], style: '0s', quad: '1'},
    {Comb:[0,10,2,30], style: '0s', quad: '1'},
    {Comb:[0,10,20,12], style: '0s', quad: '1'},	
    {Comb:[1,11,21,31], style: '1s', quad: '1'},
    {Comb:[21,11,21,31], style: '1s', quad: '1'},
    {Comb:[1,28,21,31], style: '1s', quad: '1'},
    {Comb:[1,11,1,31], style: '1s', quad: '1'},
    {Comb:[1,11,21,17], style: '1s', quad: '1'},
    {Comb:[2,12,22,32], style: '2s', quad: '1'},
    {Comb:[20,12,22,32], style: '2s', quad: '1'},
    {Comb:[11,12,22,32], style: '2s', quad: '1'},
    {Comb:[2,30,22,32], style: '2s', quad: '1'},
    {Comb:[2,12,6,32], style: '2s', quad: '1'},
    {Comb:[2,12,22,5], style: '2s', quad: '1'},
    {Comb:[3,13,23,33], style: '3s', quad: '1'},
    {Comb:[23,13,23,33], style: '3s', quad: '1'},
    {Comb:[3,29,23,33], style: '3s', quad: '1'},
    {Comb:[3,13,3,33], style: '3s', quad: '1'},
    {Comb:[3,13,23,4], style: '3s', quad: '1'},
    {Comb:[4,14,24,34], style: '4s', quad: '1'},
    {Comb:[33,14,24,34], style: '4s', quad: '1'},
    {Comb:[22,14,24,34], style: '4s', quad: '1'},
    {Comb:[4,25,24,34], style: '4s', quad: '1'},
    {Comb:[4,14,15,34], style: '4s', quad: '1'},
    {Comb:[4,14,24,9], style: '4s', quad: '1'},
    {Comb:[5,15,25,35], style: '5s', quad: '1'},
    {Comb:[32,15,25,35], style: '5s', quad: '1'},
	  {Comb:[5,24,25,35], style: '5s', quad: '1'},
	  {Comb:[5,15,14,35], style: '5s', quad: '1'},
	  {Comb:[5,15,25,8], style: '5s', quad: '1'},
    {Comb:[6,16,26,36], style: '6s', quad: '1'},
    {Comb:[22,16,26,36], style: '6s', quad: '1'},
    {Comb:[33,19,26,36], style: '6s', quad: '1'},
    {Comb:[6,19,26,36], style: '6s', quad: '1'},
    {Comb:[6,16,10,36], style: '6s', quad: '1'},
    {Comb:[6,16,26,7], style: '6s', quad: '1'},
    {Comb:[7,17,27], style: '7s', quad: '1'},
    {Comb:[36,17,27], style: '7s', quad: '1'},
    {Comb:[7,31,27], style: '7s', quad: '1'},
    {Comb:[7,17,18], style: '7s', quad: '1'},
    {Comb:[8,18,28], style: '8s', quad: '1'},
    {Comb:[35,18,28], style: '8s', quad: '1'},
    {Comb:[8,27,28], style: '8s', quad: '1'},
    {Comb:[8,18,11], style: '8s', quad: '1'},
    {Comb:[9,19,29], style: '9s', quad: '1'},
    {Comb:[34,19,29], style: '9s', quad: '1'},
    {Comb:[9,16,29], style: '9s', quad: '1'},
    {Comb:[9,19,13], style: '9s', quad: '1'},
